...
class GUI:
    ...
    def __init__(self):
        ...
        self.GroupDesc.grid(row=4, column=0, padx=10, pady=10)
        ...
        self.GroupEntry.grid(row=4, column=1, pady=10)
        ...
        self.GroupFileTypeLabel.grid(sticky="w",row=4, column=2, pady=10)
